		...
		<Box bg={bg} w='100%' p='5' borderRadius='md' borderWidth='1px' marginTop={10}>
			<Flex justifyContent='space-around' alignItems='' direction={{ base: 'column', md: 'column', lg: 'row' }}>
				...
				<Box marginLeft={{ base: '0', lg: '0.5rem' }} marginTop={{ base: '3' }}>
					...
					<Text fontSize='sm' fontWeight='300' marginTop={2}>Providing customer services since November 2022</Text>
				</Box>
				<Box marginLeft={{ base: '0', lg: '10%' }} marginTop={{ base: '3' }}>
					<Text fontSize='md' fontWeight='400'>📊 Products Sold</Text>
					<Text fontSize='md' fontWeight='500' marginTop={2}>{props.count}</Text>
				</Box>
				<Box marginLeft={{ base: '0', lg: '10%' }} marginTop={{ base: '3' }}>
					<Text fontSize='md' fontWeight='400'>🙂 Product Quality</Text>
