    ...
    <div class="card">
       <div class="card-header pb-0">
        <div class="d-flex align-items-center">
          <p class="mb-0 fw-bold">Add New Stock</p>
        </div>
      </div>
      <div class="card-body">
         <form action="{{ route('stock_new_store') }}" method="post">
         @csrf
            <div class="row">
               <div class="col-md-6">
               ...
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <input class="form-control" type="date" name="expire_at" autocomplete="off" required>
