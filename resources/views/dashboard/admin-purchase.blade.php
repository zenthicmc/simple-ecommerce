          ...
          <table class="table align-items-center mb-0" id="table">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td class="align-middle text-center">
                    <span class="badge badge-sm bg-gradient-success">{{ $invoice->status }}</span>
                  </td>

                  <td class="align-middle d-flex">
                     <div class="col-md-2">
                        <a href="{{ route('admin.purchase.edit',$invoice->reference) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Edit
                        </a>
                     </div>
                     <div class="col-md-2">
                        <form method="post" action="{{ route('admin.purchase.delete', $invoice->reference) }}">@csrf<input type="hidden" name="_method" value="DELETE"><button style="background: none;border: none;" type="submit" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Delete
                        </button></form>
                     </div>
                  </td>
